 ...
 * 
 * This is done to make the code on the rsfft-admin.php class more organized,
...
class Rsfft_Admin_Helper {
     ...
     * @since   1.0
     */
    public static function rsfft_api_section_callback(){
        
        /* Button to fetch API keys */
        $rsfft_action_token = 'fetch_access_token';
        $rsfft_fetch_token_url = add_query_arg( array( 'rsfft_action_token' => $rsfft_action_token ), RSFFT_ADMIN_URL );
        $nonced_fetch_token_url = wp_nonce_url( $rsfft_fetch_token_url, 'rsfft-' . $rsfft_action_token . '_fetch-token' );
        
        $html = '<div id="fetch-access-token-div">';
        $html .= '<p><br><a href="' . $nonced_fetch_token_url . '" id="rsfft_fetch_token">Generate Access Token &amp; Secret</a></p>';
        $html .= '</div>';
        
        /* Creating the button & link for cached tweets deletion */
        $rsfft_action_cache = 'delete_cached_tweets';
        $delete_cache_url = add_query_arg( array( 'rsfft_action_cache' => $rsfft_action_cache ), RSFFT_ADMIN_URL );
        $nonced_delete_cache_url = wp_nonce_url( $delete_cache_url, 'rsfft-' . $rsfft_action_cache . '_cache' );
        
        $html .= '<div id="delete_cached_tweets-div">';
        $html .= '<p><br><a href="' . $nonced_delete_cache_url . '" id="rsfft_delete_cache">Delete Cached Tweets</a></p>';
        $html .= '</div>';
     ...
     * @since 1.0
     */
    public static function rsfft_consumer_key_callback( $args ){
        ...
        $html = "<input type='text' id='consumer_key' name='rsfft_settings_options[consumer_key]' value='$consumer_key' />";
        $html .= "<label for='consumer_key'> &nbsp;&nbsp;" . $args[0] . "</label>";
        
        /* hidden field ( don't want to create "add_settings_field" as it needs to stay hidden ) */
        $html .= "<input type='hidden' id='app_consumer_key' name='rsfft_settings_options[app_consumer_key]' value='$app_consumer_key' />";
     ...
     * @since 1.0
     */
    public static function rsfft_consumer_secret_callback( $args ){
        ...
        $html = "<input type='text' id='consumer_secret' name='rsfft_settings_options[consumer_secret]' value='$consumer_secret' />";
        $html .= "<label for='consumer_secret'> &nbsp;&nbsp;" . $args[0] . "</label>";
        
        /* hidden field ( don't want to create "add_settings_field" as it needs to stay hidden ) */
        $html .= "<input type='hidden' id='app_consumer_secret' name='rsfft_settings_options[app_consumer_secret]' value='$app_consumer_secret' />";
     ...
     * @since 1.0
     */
    public static function rsfft_access_token_callback( $args ){
        
        $options = get_option( 'rsfft_settings_options' );
        $access_token = isset( $options[ 'access_token' ] ) ? sanitize_text_field( $options[ 'access_token' ] ) : '';
        
        $html = "<input type='text' id='access_token' name='rsfft_settings_options[access_token]' value='$access_token' />";
     ...
     * @since 1.0
     */
    public static function rsfft_access_token_secret_callback( $args ){
        
        $options = get_option( 'rsfft_settings_options' );
        $access_token_secret = isset( $options[ 'access_token_secret' ] ) ? sanitize_text_field( $options[ 'access_token_secret' ] ) : '';
        
        $html = "<input type='text' id='access_token_secret' name='rsfft_settings_options[access_token_secret]' value='$access_token_secret' />";
     ...
     */
    public static function rsfft_api_plugin_settings_section_callback(){
     ...
     */
    public static function rsfft_preserve_settings_callback( $args ){
        $options = get_option( 'rsfft_settings_options' );
        $preserve_settings = isset( $options[ 'preserve_settings' ] ) ? strip_tags( $options[ 'preserve_settings' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="preserve_settings" name="rsfft_settings_options[preserve_settings]" value="1" ' . checked( 1, $preserve_settings, false ) . '>';
     ...
     */
    public static function rsfft_api_invalidate_token_section_callback() {
        $invalidate_token_url = add_query_arg( 
                array( 
                    'rsfft_action' => 'invalidate_token',
                ));
        
        $nonced_invalidate_url = wp_nonce_url( $invalidate_token_url, 'rsfft-invalidate_token_bearer-token');
        ...
        $html .= '<p><a href="' . $nonced_invalidate_url . '" id="rsfft_invalidate_token"> Click To Invalidate & Generate New Bearer Token</a></p>';
        $html .= '<br><br><br>';
        echo $html;
    }
    ...
    public static function rsfft_feed_type_callback( $args ){
    ...
    public static function rsfft_screen_name_callback( $args ){
        
        $options = get_option( 'rsfft_customize_options' );
        $screen_name = isset( $options[ 'screen_name' ] ) ? sanitize_text_field( $options[ 'screen_name' ] ) : 'raycreations';
        
        $html = "<input type='text' id='rsfft_customize_options[screen_name]' name='rsfft_customize_options[screen_name]' value='$screen_name' />";
    ...
    public static function rsfft_hashtags_callback( $args ){
    ...
    public static function rsfft_search_string_callback( $args ) {
    ...
    public static function rsfft_include_media_type_callback( $args ) {
    ...
    public static function rsfft_exclude_replies_callback( $args ){
        
        $options = get_option( 'rsfft_customize_options' );
        $exclude_replies = isset( $options[ 'exclude_replies' ] ) ? strip_tags( $options[ 'exclude_replies' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="exclude_replies" name="rsfft_customize_options[exclude_replies]" value="1" ' . checked( 1, $exclude_replies, false ) . '>';
    ...
    /* Function to output the HTML for Exclude Replies checkbox field */
    public static function rsfft_include_retweets_callback( $args ){
        
        $options = get_option( 'rsfft_customize_options' );
        $include_rts = isset( $options[ 'include_rts' ] ) ? strip_tags( $options[ 'include_rts' ] ) : 0;
        
        $html = '<input type="checkbox" id="include_rts" name="rsfft_customize_options[include_rts]" value="1" ' . checked( 1, $include_rts, false ) . '>';
     ...
     */
    public static function rsfft_layout_section_callback(){
     ...
     */
    public static function rsfft_width_type_callback( $args ){
        
        $options = get_option( 'rsfft_customize_options' );
        $feed_width_type = isset( $options[ 'feed_width_type' ] ) ? sanitize_text_field( $options[ 'feed_width_type' ] ) : 'responsive';
        
        // Values are: fixed, percentage
        $html = "<input type='radio' id='responsive' name='rsfft_customize_options[feed_width_type]' checked disabled value='responsive'> Responsive </input>";
     ...
     */
    public static function rsfft_display_style_callback( $args ) {
    ...
    public static function rsfft_hide_media_callback( $args ){
     ...
     */
    public static function rsfft_number_of_tweets_callback( $args ){
        $options = get_option( 'rsfft_customize_options' );
        $number_of_tweets = isset( $options[ 'number_of_tweets' ] ) ? intval( $options[ 'number_of_tweets' ] ) : '10';
        
        $html = "<input type='text' id='number_of_tweets' name='rsfft_customize_options[number_of_tweets]' value='$number_of_tweets' />";
     ...
     */
    public static function rsfft_number_of_tweets_in_row_callback( $args ){
        $options = get_option( 'rsfft_customize_options' );
        $number_of_tweets_in_row = isset( $options[ 'number_of_tweets_in_row' ] ) ? intval( $options[ 'number_of_tweets_in_row' ] ) : '3';
        
        $html = "<input type='text' id='number_of_tweets_in_row' name='rsfft_customize_options[number_of_tweets_in_row]' value='$number_of_tweets_in_row' />";
     ...
     */
    public static function rsfft_check_tweets_every_callback( $args ){
        $options = get_option( 'rsfft_customize_options' );
        ...
        $html = "<input type='radio' name='rsfft_customize_options[check_tweets_every]'" . checked( 'hour', $check_tweets_every, false)  . " id='hour' value='hour'> hour </input>";
        $html .= "<input type='radio' name='rsfft_customize_options[check_tweets_every]'" . checked( 'day', $check_tweets_every, false)  . " id='day' value='day'> day </input>";
     ...
     */
    public static function rsfft_tweet_checking_interval_callback( $args ){
        $options = get_option( 'rsfft_customize_options' );
        $tweet_checking_interval = isset( $options[ 'tweet_checking_interval' ] ) ? intval( $options[ 'tweet_checking_interval' ] ) : '1';
        
        $html = "<input type='text' id='tweet_checking_interval' name='rsfft_customize_options[tweet_checking_interval]' value='$tweet_checking_interval' />";
     ...
     */
    public static function rsfft_customize_links_section_callback(){
        echo "Link related settings";
    }
    
    
    /* Function to output the HTML for 'remove external links' checkbox field */
    public static function rsfft_customize_links_hashtags_callback( $args ){
    ...
    /* Function to output the HTML for 'remove external links' checkbox field */
    public static function rsfft_customize_links_mentions_callback( $args ){
    ...
    /* Function to output the HTML for 'remove external links' checkbox field */
    public static function rsfft_customize_remove_ext_links_callback( $args ){
    ...
    public static function rsfft_customize_link_add_nofollow_callback( $args ){
        
        $options = get_option( 'rsfft_customize_options' );
        $nofollow_ext_links = isset( $options[ 'nofollow_ext_links' ] ) ? strip_tags( $options[ 'nofollow_ext_links' ] ) : 0;
        
        $html = '<input type="checkbox" id="nofollow_ext_links" name="rsfft_customize_options[nofollow_ext_links]" value="1" ' . checked( 1, $nofollow_ext_links, false ) . '>';
     ...
     */
    public static function rsfft_tweet_general_section_callback(){
        
        /* Creating the button & link to 'reset to default' option for tweet visibility option */
        $rsfft_action = 'reset_tweets_visibility';
        $reset_visibility_url = add_query_arg( array( 'tab' => 'tweets', 'rsfft_action_reset' => $rsfft_action ), RSFFT_ADMIN_URL );
        $nonced_reset_visibility_url = wp_nonce_url( $reset_visibility_url, 'rsfft-' . $rsfft_action . '_reset' );
        
        $html = '<div id="reset-tweets-visibility-div">';
        $html .= '<p><a href="' . $nonced_reset_visibility_url . '" id="rsfft_reset_visibility">Reset To Default Options</a></p>';
        $html .= '</div>';
    ...
    public static function rsfft_tweet_display_border_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_tweet_border = isset( $options[ 'display_tweet_border' ] ) ? strip_tags( $options[ 'display_tweet_border' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_tweet_border" name="rsfft_tweets_options[display_tweet_border]" value="1" ' . checked( 1, $display_tweet_border, false ) . '>';
     ...
     * Functions & callbacks for the Tweets tab - 'Tweet Header' section 
     */
    public static function rsfft_tweet_header_section_callback(){
    ...
    public static function rsfft_display_header_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_header = isset( $options[ 'display_header' ] ) ? strip_tags( $options[ 'display_header' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_header" name="rsfft_tweets_options[display_header]" value="1" ' . checked( 1, $display_header, false ) . '>';
        $html .= '<label for="display_header"> ' . $args[0] . '</label>';
    ...
    public static function rsfft_display_profile_img_header_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_profile_img_header = isset( $options[ 'display_profile_img_header' ] ) ? strip_tags( $options[ 'display_profile_img_header' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_profile_img_header" name="rsfft_tweets_options[display_profile_img_header]" value="1" ' . checked( 1, $display_profile_img_header, false ) . '>';
    ...
    public static function rsfft_display_name_header_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_name_header = isset( $options[ 'display_name_header' ] ) ? strip_tags( $options[ 'display_name_header' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_name_header" name="rsfft_tweets_options[display_name_header]" value="1" ' . checked( 1, $display_name_header, false ) . '>';
    ...
    /* Function to output the HTML for Twitter Display name checkbox field */
    public static function rsfft_display_screen_name_header_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_screen_name_header = isset( $options[ 'display_screen_name_header' ] ) ? strip_tags( $options[ 'display_screen_name_header' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_screen_name_header" name="rsfft_tweets_options[display_screen_name_header]" value="1" ' . checked( 1, $display_screen_name_header, false ) . '>';
    ...
    /* Function to output the HTML for Twitter Display name checkbox field */
    public static function rsfft_display_date_header_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_date_header = isset( $options[ 'display_date_header' ] ) ? strip_tags( $options[ 'display_date_header' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_date_header" name="rsfft_tweets_options[display_date_header]" value="1" ' . checked( 1, $display_date_header, false ) . '>';
     ...
     */
    public static function rsfft_tweet_footer_section_callback(){
    ...
    public static function rsfft_display_tweet_footer_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_footer = isset( $options[ 'display_footer' ] ) ? strip_tags( $options[ 'display_footer' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_footer" name="rsfft_tweets_options[display_footer]" value="1" ' . checked( 1, $display_footer, false ) . '>';
    ...
    public static function rsfft_display_likes_footer_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_likes_footer = isset( $options[ 'display_likes_footer' ] ) ? strip_tags( $options[ 'display_likes_footer' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_likes_footer" name="rsfft_tweets_options[display_likes_footer]" value="1" ' . checked( 1, $display_likes_footer, false ) . '>';
    ...
    public static function rsfft_display_retweets_footer_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_retweets_footer = isset( $options[ 'display_retweets_footer' ] ) ? strip_tags( $options[ 'display_retweets_footer' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_retweets_footer" name="rsfft_tweets_options[display_retweets_footer]" value="1" ' . checked( 1, $display_retweets_footer, false ) . '>';
    ...
    /* Function to output the HTML for Display Retweets checkbox field */
    public static function rsfft_display_screen_name_footer_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_screen_name_footer = isset( $options[ 'display_screen_name_footer' ] ) ? strip_tags( $options[ 'display_screen_name_footer' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_screen_name_footer" name="rsfft_tweets_options[display_screen_name_footer]" value="1" ' . checked( 1, $display_screen_name_footer, false ) . '>';
    ...
    /* Function to output the HTML for Display Retweets checkbox field */
    public static function rsfft_display_date_footer_callback( $args ){
        
        $options = get_option( 'rsfft_tweets_options' );
        $display_date_footer = isset( $options[ 'display_date_footer' ] ) ? strip_tags( $options[ 'display_date_footer' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="display_date_footer" name="rsfft_tweets_options[display_date_footer]" value="1" ' . checked( 1, $display_date_footer, false ) . '>';
     ...
     */
    public static function rsfft_style_general_section_callback(){
        
        /* Creating the button & link to 'reset to default' option for tweet visibility option */
        $rsfft_action = 'reset_style';
        $reset_style_url = add_query_arg( array( 'tab' => 'style', 'rsfft_action_reset' => $rsfft_action ), RSFFT_ADMIN_URL );
        $nonced_reset_style_url = wp_nonce_url( $reset_style_url, 'rsfft-' . $rsfft_action . '_reset' );
        
        $html = '<div id="reset-style-div">';
        $html .= '<p><a href="' . $nonced_reset_style_url . '" id="rsfft_reset_style">Reset To Default Options</a></p>';
        $html .= '</div>';
    ...
    public static function rsfft_style_font_size_callback( $args ) {
    ...
    public static function rsfft_style_font_color_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $font_color = isset( $options[ 'font_color' ] ) ? sanitize_text_field( $options[ 'font_color' ] ) : '';
        
        $html = "<input type='text' id='font_color' name='rsfft_style_options[font_color]' value='$font_color' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_link_text_decoration_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $link_text_decoration = isset( $options[ 'link_text_decoration' ] ) ? sanitize_text_field( $options[ 'link_text_decoration' ] ) : 'inherit';
 
        //Get the various font sizes
        $textDecorations = Rsfft_Admin::$textDecorations;
        
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[link_text_decoration]" name="rsfft_style_options[link_text_decoration]">';
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[link_text_decoration]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    /**
    public static function rsfft_style_feed_bg_color_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $feed_bg_color = isset( $options[ 'feed_bg_color' ] ) ? sanitize_text_field( $options[ 'feed_bg_color' ] ) : '';
        
        $html = "<input type='text' id='feed_bg_color' name='rsfft_style_options[feed_bg_color]' value='$feed_bg_color' class='rsfft-color-fields' />";
    ...
    */
    ...
    public static function rsfft_style_tweet_bg_color_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $tweet_bg_color = isset( $options[ 'tweet_bg_color' ] ) ? sanitize_text_field( $options[ 'tweet_bg_color' ] ) : '';
        
        $html = "<input type='text' id='tweet_bg_color' name='rsfft_style_options[tweet_bg_color]' value='$tweet_bg_color' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_tweet_border_type_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[border_type]" name="rsfft_style_options[border_type]">';
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[border_type]'> &nbsp; &nbsp;" . $args[0] . "</label>";
     ...
     */
    public static function rsfft_style_header_section_callback(){
    ...
    /* Function to output the HTML for choosing general font-size */
    public static function rsfft_style_font_size_header_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $font_size_header = isset( $options[ 'font_size_header' ] ) ? sanitize_text_field( $options[ 'font_size_header' ] ) : '95';
        
        //Get the various font sizes
        $fontPercentages = Rsfft_Admin::$fontPercents;
        
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[font_size_header]" name="rsfft_style_options[font_size_header]">';
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[font_size_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_name_font_color_header_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $name_font_color_header = isset( $options[ 'name_font_color_header' ] ) ? sanitize_text_field( $options[ 'name_font_color_header' ] ) : '#000';
        
        $html = "<input type='text' id='name_font_color_header' name='rsfft_style_options[name_font_color_header]' value='$name_font_color_header' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_name_font_weight_header_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $name_font_weight_header = isset( $options[ 'name_font_weight_header' ] ) ? sanitize_text_field( $options[ 'name_font_weight_header' ] ) : 'bold';
        
        //Get the various font sizes
        $fontWeights = Rsfft_Admin::$fontWeights;
        
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[name_font_weight_header]" name="rsfft_style_options[name_font_weight_header]">';
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[name_font_weight_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_screen_name_font_size_header_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[screen_name_font_size_header]" name="rsfft_style_options[screen_name_font_size_header]">';
                foreach ( $fontPercentages as $fontPercentage ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[screen_name_font_size_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_screen_name_font_color_header_callback( $args ) {
        ...
        $html = "<input type='text' id='screen_name_font_color_header' name='rsfft_style_options[screen_name_font_color_header]' value='$screen_name_font_color_header' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_screen_name_font_weight_header_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[screen_name_font_weight_header]" name="rsfft_style_options[screen_name_font_weight_header]">';
                foreach ( $fontWeights as $fontWeight ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[screen_name_font_weight_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_date_font_size_header_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[date_font_size_header]" name="rsfft_style_options[date_font_size_header]">';
                foreach ( $fontPercentages as $fontPercentage ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[date_font_size_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    /* Function to output the HTML for Header "Screen Name" Font color */
    public static function rsfft_style_date_font_color_header_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $date_font_color_header = isset( $options[ 'date_font_color_header' ] ) ? sanitize_text_field( $options[ 'date_font_color_header' ] ) : '#999';
        
        $html = "<input type='text' id='date_font_color_header' name='rsfft_style_options[date_font_color_header]' value='$date_font_color_header' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_date_font_weight_header_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[date_font_weight_header]" name="rsfft_style_options[date_font_weight_header]">';
                foreach ( $fontWeights as $fontWeight ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[date_font_weight_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_link_text_decoration_header_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[link_text_decoration_header]" name="rsfft_style_options[link_text_decoration_header]">';
                foreach ( $textDecorations as $textDecoration ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[link_text_decoration_header]'> &nbsp; &nbsp;" . $args[0] . "</label>";
     ...
     */
    public static function rsfft_style_tweet_section_callback(){
        echo "This section lets you control the Styling of the Tweet itself";
    }
    
    /* Function to output the HTML for choosing general font-size */
    public static function rsfft_style_font_size_tweet_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[font_size_tweet]" name="rsfft_style_options[font_size_tweet]">';
                foreach ( $fontPercentages as $fontPercentage ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[font_size_tweet]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    /* Function to output the HTML for Header "Screen Name" Font color */
    public static function rsfft_style_font_color_tweet_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $font_color_tweet = isset( $options[ 'font_color_tweet' ] ) ? sanitize_text_field( $options[ 'font_color_tweet' ] ) : '';
        
        $html = "<input type='text' id='font_color_tweet' name='rsfft_style_options[font_color_tweet]' value='$font_color_tweet' class='rsfft-color-fields' />";
    ...
    /* Function to output the HTML for choosing "Date" Font Weight in header section */
    public static function rsfft_style_font_weight_tweet_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[font_weight_tweet]" name="rsfft_style_options[font_weight_tweet]">';
                foreach ( $fontWeights as $fontWeight ) {
                    $html .= '<option value="' . esc_attr( $fontWeight ) . '" ' . selected( $font_weight_tweet, $fontWeight, false ) . '>' . sanitize_text_field( $fontWeight ) . '</option>' ;
                }
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[font_weight_tweet]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_link_color_tweet_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $link_color_tweet = isset( $options[ 'link_color_tweet' ] ) ? sanitize_text_field( $options[ 'link_color_tweet' ] ) : '';
        
        $html = "<input type='text' id='font_color_tweet' name='rsfft_style_options[link_color_tweet]' value='$link_color_tweet' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_link_text_decoration_tweet_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[link_text_decoration_tweet]" name="rsfft_style_options[link_text_decoration_tweet]">';
                foreach ( $textDecorations as $textDecoration ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[link_text_decoration_tweet]'> &nbsp; &nbsp;" . $args[0] . "</label>";
     ...
     */
    public static function rsfft_style_footer_section_callback(){
    ...
    /* Function to output the HTML for choosing general font-size */
    public static function rsfft_style_font_size_footer_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[font_size_footer]" name="rsfft_style_options[font_size_footer]">';
                foreach ( $fontPercentages as $fontPercentage ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[font_size_footer]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_like_icon_color_footer_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $like_icon_color_footer = isset( $options[ 'like_icon_color_footer' ] ) ? sanitize_text_field( $options[ 'like_icon_color_footer' ] ) : '';
        
        $html = "<input type='text' id='like_icon_color_footer' name='rsfft_style_options[like_icon_color_footer]' value='$like_icon_color_footer' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_like_count_color_footer_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $like_count_color_footer = isset( $options[ 'like_count_color_footer' ] ) ? sanitize_text_field( $options[ 'like_count_color_footer' ] ) : '';
        
        $html = "<input type='text' id='like_count_color_footer' name='rsfft_style_options[like_count_color_footer]' value='$like_count_color_footer' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_retweet_icon_color_footer_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $retweet_icon_color_footer = isset( $options[ 'retweet_icon_color_footer' ] ) ? sanitize_text_field( $options[ 'retweet_icon_color_footer' ] ) : '';
        
        $html = "<input type='text' id='retweet_icon_color_footer' name='rsfft_style_options[retweet_icon_color_footer]' value='$retweet_icon_color_footer' class='rsfft-color-fields' />";
    ...
    /* Function to output the HTML for Like count color for the Style Footer section */
    public static function rsfft_style_retweet_count_color_footer_callback( $args ) {
        ...
        $html = "<input type='text' id='retweet_count_color_footer' name='rsfft_style_options[retweet_count_color_footer]' value='$retweet_count_color_footer' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_screen_name_font_color_footer_callback( $args ) {
        ...
        $html = "<input type='text' id='screen_name_font_color_footer' name='rsfft_style_options[screen_name_font_color_footer]' value='$screen_name_font_color_footer' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_screen_name_font_weight_footer_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[screen_name_font_weight_footer]" name="rsfft_style_options[screen_name_font_weight_footer]">';
                foreach ( $fontWeights as $fontWeight ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[screen_name_font_weight_footer]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    /* Function to output the HTML for Screen Name Font Color for the Style Footer section */
    public static function rsfft_style_date_font_color_footer_callback( $args ) {
        
        $options = get_option( 'rsfft_style_options' );
        $date_font_color_footer = isset( $options[ 'date_font_color_footer' ] ) ? sanitize_text_field( $options[ 'date_font_color_footer' ] ) : '';
        
        $html = "<input type='text' id='date_font_color_footer' name='rsfft_style_options[date_font_color_footer]' value='$date_font_color_footer' class='rsfft-color-fields' />";
    ...
    public static function rsfft_style_date_font_weight_footer_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[date_font_weight_footer]" name="rsfft_style_options[date_font_weight_footer]">';
                foreach ( $fontWeights as $fontWeight ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[date_font_weight_footer]'> &nbsp; &nbsp;" . $args[0] . "</label>";
    ...
    public static function rsfft_style_link_text_decoration_footer_callback( $args ) {
        ...
        $html = '';
            //Loop through all the font sizes and display them in select control
            $html .= '<select id="rsfft_style_options[link_text_decoration_footer]" name="rsfft_style_options[link_text_decoration_footer]">';
                foreach ( $textDecorations as $textDecoration ) {
            ...
            $html .= '</select>';
        $html .= "<label for='rsfft_style_options[link_text_decoration_footer]'> &nbsp; &nbsp;" . $args[0] . "</label>";
     ...
     */
    public static function rsfft_slider_carousel_general_section_callback(){
        
        /* Creating the button & link to 'reset to default' option for tweet visibility option */
        $rsfft_action = 'reset_slider_options';
        $reset_slider_options_url = add_query_arg( array( 'tab' => 'slider', 'rsfft_action_reset' => $rsfft_action ), RSFFT_ADMIN_URL );
        $nonced_reset_slider_options_url = wp_nonce_url( $reset_slider_options_url, 'rsfft-' . $rsfft_action . '_reset' );
        
        $html = '<div id="reset-slider-div">';
        $html .= '<p><a href="' . $nonced_reset_slider_options_url . '" id="rsfft_reset_slider">Reset To Default Options</a></p>';
        $html .= '</div>';
     ...
     */
    public static function rsfft_slider_carousel_nav_arrows_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $nav_arrows = isset( $options[ 'nav_arrows' ] ) ? strip_tags( $options[ 'nav_arrows' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="nav_arrows" name="rsfft_slider_carousel_options[nav_arrows]" value="1" ' . checked( 1, $nav_arrows, false ) . '>';
     ...
     */
    public static function rsfft_slider_carousel_nav_dots_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $nav_dots = isset( $options[ 'nav_dots' ] ) ? strip_tags( $options[ 'nav_dots' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="nav_dots" name="rsfft_slider_carousel_options[nav_dots]" value="1" ' . checked( 1, $nav_dots, false ) . '>';
     ...
     * Adding the checkbox field for Navigation Dots under "Slider/Carousel" General tab
     */
    public static function rsfft_slider_carousel_autoplay_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $autoplay = isset( $options[ 'autoplay' ] ) ? strip_tags( $options[ 'autoplay' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="autoplay" name="rsfft_slider_carousel_options[autoplay]" value="1" ' . checked( 1, $autoplay, false ) . '>';
    ...
    public static function rsfft_slider_carousel_transition_interval_callback( $args ) {
        
        $options = get_option( 'rsfft_slider_carousel_options' );
        $transition_interval = isset( $options[ 'transition_interval' ] ) ? sanitize_text_field( $options[ 'transition_interval' ] ) : '7';
        
        $html = "<input type='text' id='transition_interval' name='rsfft_slider_carousel_options[transition_interval]' value='$transition_interval' />";
    ...
    public static function rsfft_slider_carousel_transition_speed_callback( $args ) {
        
        $options = get_option( 'rsfft_slider_carousel_options' );
        $transition_speed = isset( $options[ 'transition_speed' ] ) ? sanitize_text_field( $options[ 'transition_speed' ] ) : '3';
        
        $html = "<input type='text' id='transition_speed' name='rsfft_slider_carousel_options[transition_speed]' value='$transition_speed' />";
     ...
     */
    public static function rsfft_slider_carousel_pause_on_hover_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $pause_on_hover = isset( $options[ 'pause_on_hover' ] ) ? strip_tags( $options[ 'pause_on_hover' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="pause_on_hover" name="rsfft_slider_carousel_options[pause_on_hover]" value="1" ' . checked( 1, $pause_on_hover, false ) . '>';
     ...
     * Function to output the checkbox field for 'Pause on Hover' under "Slider/Carousel" General tab
     */
    public static function rsfft_slider_carousel_loop_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $loop = isset( $options[ 'loop' ] ) ? strip_tags( $options[ 'loop' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="loop" name="rsfft_slider_carousel_options[loop]" value="1" ' . checked( 1, $loop, false ) . '>';
     ...
     */
    public static function rsfft_slider_carousel_slider_section_callback(){
     ...
     */
    public static function rsfft_slider_carousel_auto_height_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        $auto_height = isset( $options[ 'auto_height' ] ) ? strip_tags( $options[ 'auto_height' ] ) : FALSE;
        
        $html = '<input type="checkbox" id="auto_height" name="rsfft_slider_carousel_options[auto_height]" value="1" ' . checked( 1, $auto_height, false ) . '>';
     ...
     */
    public static function rsfft_slider_carousel_carousel_section_callback(){
     ...
     */
    public static function rsfft_slider_carousel_items_on_screen_callback( $args ){
        $options = get_option( 'rsfft_slider_carousel_options' );
        ...
        $html = '';
            ...
            //Loop through all the font sizes and display them in select control
            $html .= '<select disabled id="rsfft_slider_carousel_options[items_on_screen]" name="rsfft_slider_carousel_options[items_on_screen]">';
        ...
        $html .= "<label for='rsfft_slider_carousel_options[items_on_screen]'> &nbsp; &nbsp;" . $args[0] . "</label>";
     ...
     */
    public static function rsfft_api_support_settings_section_callback(){
        $html = '';
        ...
        $html .= '<table class="widefat rsfft-scode-table">';
            $html .= '<thead>';
                $html .= '<tr>';
            ...
            $html .= '<tbody>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets feed_type="user_timeline"]<br>'
                            ...
                            . '[my_custom_tweets feed_type="hashtags_timeline"]<span class="rsfft_tip">(Available in Pro)</span><br>'
                            . '[my_custom_tweets feed_type="search_timeline"]<span class="rsfft_tip">(Available in Pro)</span><br></td>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets display_style="display_list"]<br>'
                            . '[my_custom_tweets display_style="display_masonry"]<span class="rsfft_tip">(Available in Pro)</span><br>'
                            . '[my_custom_tweets display_style="display_slider_1_col"]<br>'
                            . '[my_custom_tweets display_style="display_slider_2_col"]<span class="rsfft_tip">(Available in Pro)</span><br></td>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets hide_media="1"]<span class="rsfft_tip">(Available in Pro)</span></td>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets remove_links_hashtags="1"]<span class="rsfft_tip">(Available in Pro)</span></td>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets remove_links_mentions="1"]<span class="rsfft_tip">(Available in Pro)</span></td>';
                ...
                $html .= '<tr>';
                    ...
                    $html .= '<td>[my_custom_tweets remove_ext_links="1"]<span class="rsfft_tip">(Available in Pro)</span></td>';
     ...
     */
    public static function rsfft_settings_validate_options( $input ) {
        ...
        return apply_filters( 'rsfft_settings_validate_options', $valid, $input );
        
    }//ends rsfft_settings_validate_options
     ...
     * @return  $valid  array   An array of validated inputs
     */
    public static function rsfft_customize_validate_options( $input ) {
        ...
        //Return the array processing any additional functions filtered by this action
        return apply_filters( 'rsfft_customize_validate_options', $valid, $input );
        
        
    }//ends rsfft_customize_validate_options
     ...
     * @return  $valid  array   An array of validated inputs
     */
    public static function rsfft_tweets_validate_options( $input ) {
        ...
        //Return the array processing any additional functions filtered by this action
        return apply_filters( 'rsfft_tweets_validate_options', $valid, $input );
        
    }//ends rsfft_tweets_validate_options
     ...
     * @return  $valid  array   An array of validated inputs
     */
    public static function rsfft_style_validate_options( $input ) {
        ...
        foreach ( $color_options as $color_option ) {
            $valid[ $color_option ] = Rsfft_Admin_Helper::rsfft_validate_hex_color_code( $valid[ $color_option ], $color_option );
        }
        
        //Return the array processing any additional functions filtered by this action
        return apply_filters( 'rsfft_style_validate_options', $valid, $input );
     ...
     */
    public static function rsfft_validate_hex_color_code( $hexcolor, $option ) {
        ...
        if ( preg_match( '/^#[a-f0-9]{6}$/i', $hexcolor ) ) { // if user insert a HEX color with #     
            ...
            add_settings_error( 'rsfft_style_options', 'rsfft_font_color_error', 'Invalid ' . $option . ' entered...', 'error' );
    ...
    }//ends rsfft_validate_hex_color_code
     ...
     * @return  $valid  array   An array of validated inputs
     */
    public static function rsfft_slider_carousel_validate_options( $input ) {
        ...
        //Return the array processing any additional functions filtered by this action
        return apply_filters( 'rsfft_slider_carousel_validate_options', $valid, $input );
     ...
     * @since 1.2.1
     */
    public static function rsfft_reset_options( $action ){
        ...
        if ( $action == 'reset_tweets_visibility' ) {
            ...
            update_option( 'rsfft_tweets_options', $tweet_show_hide_args_default );
            $status = TRUE;
            ...
            //reset the values with new options
            update_option( 'rsfft_style_options', $style_args );
            $status = TRUE;
            ...
            //reset the values with new options
            update_option( 'rsfft_slider_carousel_options', $slider_args );
            $status = TRUE;
